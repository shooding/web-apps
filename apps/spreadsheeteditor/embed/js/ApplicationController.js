...
//    Common.Analytics.initialize('UA-12442749-13', 'Embedded Spreadsheet Editor');
    ...
    function onPrint() {
        if ( permissions.print!==false )
            api.asc_Print(new Asc.asc_CDownloadOptions(null, $.browser.chrome || $.browser.webkit || $.browser.safari || $.browser.opera || $.browser.mozilla && $.browser.versionNumber>86));
    }
    ...
    function onDocumentContentReady() {
        ...
        SSE.ApplicationView.tools.get('#idt-print')
            .on('click', function(){
                api.asc_Print(new Asc.asc_CDownloadOptions(null, $.browser.chrome || $.browser.safari || $.browser.webkit || $.browser.opera || $.browser.mozilla && $.browser.versionNumber>86));
